  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="outline"
          className="gap-2 w-full justify-between bg-sidebar-accent/60 hover:bg-sidebar-accent text-sidebar-foreground border-sidebar-border min-h-12 h-auto py-2 px-3 text-sm"
        >
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            ...
            <span
              className="font-medium text-left leading-tight break-words line-clamp-2 min-w-0 flex-1"
