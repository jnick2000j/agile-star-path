...
-- Make plan_id nullable so a subscription row can exist before a plan is chosen
ALTER TABLE public.organization_subscriptions ALTER COLUMN plan_id DROP NOT NULL;

-- Update platform_admin_create_organization to default to the Free plan when present
...
BEGIN
  ...
  VALUES (_org_id, _plan_id, 'trialing')
