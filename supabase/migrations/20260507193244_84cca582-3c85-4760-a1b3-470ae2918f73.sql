-- Replace spawn function: spawn ALL tasks at the next pending step concurrently
...
BEGIN
  ...
  -- Don't spawn the next stage while any task in the current stage is still open
  ...
  -- Find the next step that hasn't been spawned yet
  ...
  -- Spawn EVERY task at this step (concurrent)
  FOR v_task IN
